# Count Substring Occurrences  - add new solutions later

# This function should take a main string and a substring as inputs and return the number of occurrences of
# the substring within the main string. It should not be case-sensitive and may overlap.
...
#     return int(main_str.lower().count(sub_str.lower()))
...
def count_occurrences(main_str: str, sub_str: str) -> int:
    regex = '(?='+sub_str.lower()+')'
    # print(regex)
    return len(re.findall(regex, main_str.lower()))
